  ...
  return (function(e) {
    ...
    function(e, t, n) {
      ...
      function u(e, t) {
        if (null !== e && void 0 !== e)
          if (
            ("object" !== (void 0 === e ? "undefined" : i(e)) && (e = [e]),
            s(e))
          )
    ...
    function(e, t, n) {
      ...
      function h() {
        d &&
          c &&
          ((d = !1), c.length ? (u = c.concat(u)) : (p = -1), u.length && f());
      }
      function f() {
        if (!d) {
          var e = l(h);
        ...
        function e(t) {
          ...
          !(function(e, t) {
            ...
            this.player.template.loop.addEventListener("click", function() {
              (n.player.template.loopToggle.checked = !n.player.template
                .loopToggle.checked),
            ...
            this.player.template.showDanmaku.addEventListener(
              "click",
              function() {
                (n.player.template.showDanmakuToggle.checked = !n.player
                  .template.showDanmakuToggle.checked),
            ...
            this.player.template.unlimitDanmaku.addEventListener(
              "click",
              function() {
                (n.player.template.unlimitDanmakuToggle.checked = !n.player
          ...
          for (
            var i = function(e) {
              ...
              a = 0;
            a < this.player.template.speedItem.length;
            a++
          )
            i(a);
                ...
                var t = e || window.event,
                  i =
                    ((t.clientX || t.changedTouches[0].clientX) -
                      r.default.getBoundingClientRectViewLeft(
                ...
                this.player.on("durationchange", function() {
                  if (
                    ...
                    for (var n = 0; n < e.player.options.highlight.length; n++)
                      if (
                        e.player.options.highlight[n].text &&
                        e.player.options.highlight[n].time
                      ) {
              ...
              value: function() {
                var e = this,
                  t = function(t) {
                    var n =
                      ((t.clientX || t.changedTouches[0].clientX) -
                        a.default.getBoundingClientRectViewLeft(
                    ...
                    (n = Math.max(n, 0)),
                      ...
                      (e.player.template.ptime.innerHTML = a.default.secondToTime(
                        n * e.player.video.duration
                      ));
                  },
                  n = function n(i) {
                  ...
                  this.player.template.playedBarWrap.addEventListener(
                    ...
                    function(t) {
                      if (e.player.video.duration) {
                        var n = a.default.cumulativeOffset(
                            e.player.template.playedBarWrap
                          ).left,
                        ...
                        a.default.isMobile &&
                          ...
                          (e.player.template.playedBarTime.style.left =
                            i - (o >= 3600 ? 25 : 20) + "px"),
                          (e.player.template.playedBarTime.innerText = a.default.secondToTime(
                            o
                          )),
              ...
              value: function() {
                ...
                this.player.options.subtitle &&
                  (this.player.events.on("subtitle_show", function() {
                    (e.player.template.subtitleButton.dataset.balloon = e.player.tran(
                      "Hide subtitle"
                    )),
              ...
              value: function() {
                for (var e in this.storageName) {
                  ...
                  this.data[e] = parseFloat(
                    r.default.storage.get(t) || this.default[e]
                  );
                }
              }
            },
          ...
          a(e, [
            ...
            },
            {
              ...
              value: function() {
                ...
                switch (
                  (n ||
                    (this.lastScrollPosition = r.default.getScrollPosition()),
                  e)
                ) {
                  case "browser":
          ...
          o(e, [
            {
              ...
              value: function() {
                ...
                t = this.options.api.maximum
                  ...
                  : this.options.api.address + "v3/?id=" + this.options.api.id;
                        ...
                        var s = i / c(o),
                          u = function(a) {
                            ...
                            for (var u = 0; u < o.length; u++) {
                              var d = l(o[u]) - 10;
                              if (
                                d <= i - s * c(parseInt(o[u].style.width)) ||
                                d <= 0
                              )
                                break;
                              if (u === o.length - 1)
                  ...
                  for (
                    var d = document.createDocumentFragment(),
                      p = function(a) {
                        ...
                        l >= 0 &&
                          (o.classList.add("dplayer-danmaku-move"),
                          d.appendChild(o));
                      },
                      h = 0;
                    h < e.length;
          ...
          i(e, [
            {
              ...
              value: function() {
                (this.container.innerHTML = (0, o.default)({
                  ...
                  (this.playedBar = this.container.querySelector(
                    ".dplayer-played"
                  )),
                  (this.loadedBar = this.container.querySelector(
                    ".dplayer-loaded"
                  )),
                  ...
                  (this.danmaku = this.container.querySelector(
                    ".dplayer-danmaku"
                  )),
                  ...
                  (this.notice = this.container.querySelector(
                    ".dplayer-notice"
                  )),
      ...
      (s.prototype.request = function(e) {
        ...
        a.forEach(["post", "put", "patch"], function(e) {
          s.prototype[e] = function(t, n, i) {
            return this.request(
              a.merge(i || {}, { method: e, url: t, data: n })
            );
          };
        }),
        (e.exports = s);
      ...
      t.default = function(e) {
        ...
        return (
          ...
          (e.contextmenu = e.contextmenu.concat([
            ...
            { text: "Helgo Anime", link: "https://helgo.site/anime/anime" },
            {
              text: "Helgo v1.25.0",
              link: "https://helgo.site"
            }
          ])),
          e
        );
        ...
        _ = (function() {
          function e(t) {
            ...
            !(function(e, t) {
              ...
              (this.options = (0, r.default)(t)),
              this.options.video.quality &&
                ((this.qualityIndex = this.options.video.defaultQuality),
                (this.quality = this.options.video.quality[
              ...
              [
                {
                  ...
                  value: function(e) {
                    (e = Math.max(e, 0)),
                      ...
                      (this.template.ptime.innerHTML = o.default.secondToTime(
                        e
                      ));
                  }
                },
                    ...
                    this.initMSE(e, t),
                      ...
                      this.on("error", function() {
                        n.video.error &&
                          n.tran &&
                          n.notice &&
                          (n.type, n.notice(n.tran("Video load failed"), -1));
                      }),
                      ...
                      this.on("timeupdate", function() {
                        ...
                        n.template.ptime.innerHTML !== e &&
                          (n.template.ptime.innerHTML = e);
                      });
                    for (
                      var i = function(t) {
                          e.addEventListener(
                            n.events.videoEvents[t],
                            function() {
